...
export function SectionHeader({ eyebrow, title, description, align = "left", hero = false }: SectionHeaderProps) {
  return (
    <div className={align === "center" ? "mx-auto max-w-3xl text-center" : "max-w-3xl"}>
      ...
      <h2 className={hero ? "text-4xl font-semibold leading-tight text-brand-ink md:text-6xl" : "text-3xl font-semibold leading-tight text-brand-ink md:text-4xl"}>{title}</h2>

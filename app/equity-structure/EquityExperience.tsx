...
const relationshipPaths = [
  /* 实际控制人 → 两个持股合伙企业 */
  "M500 78 V105 H220 V124", "M500 105 H780 V124",
  /* 两个合伙企业 → 龙头控股集团 */
  "M220 186 V232 H500 V266", "M780 186 V232 H500",
  /* 龙头控股集团 → 四个业务平台 */
  "M500 266 H130 V282", "M500 266 H380 V282", "M500 266 H620 V282", "M500 266 H870 V282",
  /* 制造 → 供应链；科技 → 研发中心 */
  "M130 344 V410 H75 V453", "M380 344 V410 H275 V453",
  /* 投资 → 产业投资有限合伙、海外子公司 */
  "M620 344 V410 H500 V453", "M620 410 H700 V453",
  /* 家族资产管理 → 家族资产平台 */
  "M870 344 V410 H925 V453",
];
